...
class ListTests(unittest.TestCase):
    ...
    def test_copy(self):
        ...
        self.assertFalse(lst is copy,
                         msg="The objects should be referentially equal.")
    ...
    def test_iteration(self):
        ...
        # Notice "answers" only contains 4 elements, therefore "why"
        # is not included.
    ...
    def test_udacity_intro_to_python_data_structures(self):
        ...
        most_win_director = [winner for winner, count in win_count_dict.items() if count == max_wins]
